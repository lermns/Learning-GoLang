...
func RegistarErrores() {
	/*
		El paquete [log] se utiliza para el registro básico de mensajes en la aplicación. Proporciona funcionalidades simples para
		imprimir mensajes de registro en la salida estándar y en la salida estándar de errores.
	...
	*/
	...
	log.Print("¡Oye! Mi cuerpo pide salasasas")
}
